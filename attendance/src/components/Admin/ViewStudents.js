            ...
            .then(function (response) {
                ...
                if (response.status === 203) {
                    ...
                    const r = (response.data.data || []).map((s) =>
                        createData(s.roll, s.name, s.course, s.year, s.semester, s.branch, s.email)
                    );
                    setrows(r);
                }
            })
                    ...
                    <div className=" bg-white p-5 rounded-lg lg:rounded-l-none">
                        <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                            ...
                            <div className="mb-4 md:flex md:justify-between">
                                ...
                                <div className="mb-4 md:mr-2 md:mb-0 w-1/3">
                                    <label className="block mb-2 text-sm font-bold text-gray-700 flex justify-start" htmlFor="firstName">
                                        Department
                                    </label>
