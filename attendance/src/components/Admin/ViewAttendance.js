                ...
                <div className="flex  justify-center px-6">
                    <div className="w-[80%] ">
                        ...
                        <div className="flex flex-wrap -m-2">
                            {
                                subjects.map((s) => {
                                    return <div className="p-2 lg:w-1/3 md:w-1/2 w-full" key={s.id || s.code}   >
                                        <button type="button" className="w-full text-left" onClick={() => {
                                            ...
                                            <div className="h-full flex items-center border-gray-200 border-2 hover:cursor-pointer p-4 rounded-lg hover:shadow-lg shadow-slate-300">
                                                <img alt="team" className="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRAlBPmsRECoTvlQKFoT3uT5P9xGYGmaYkRM3lYpDGgMH4kLet6VLilfda76yIPRKq5_Q&usqp=CAU" />
                                                <div className="flex-grow">
                                                    <p className="text-gray-500">{s.code}</p>
                                                    <h2 className="text-gray-900 title-font font-medium">{s.name}</h2>
                                                </div>
                                            </div>
                                        </button>
                                    </div>
