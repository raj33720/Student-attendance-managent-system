        ...
        <div>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-16 mx-auto">
                    <div className="flex flex-row text-center justify-between  mb-10 mx-[2%]">
                        <h1 className="sm:text-3xl text-2xl font-semibold title-font mb-4 text-gray-900">All Subjects</h1>
